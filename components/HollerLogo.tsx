...
export default function HollerLogo({ variant = 'full', size }: Props) {
  ...
  return (
    <div style={{ position: 'relative', width: w, height: h }}>
      {/* Frame SVG — diamonds and borders only, no text */}
      <svg
        viewBox="0 0 520 270"
        width={w}
        height={h}
      ...
      >
        ...
        <g clipPath="url(#logoClip)">
          ...
          {/* CORNER diamonds — radius 10, accent color */}
          <g fill="#8a6830">
          ...
          {/* TOP LARGE — x from 44 to 476, step 24, centered y=14 */}
          <g fill="#7a5a22">
          ...
          {/* LEFT LARGE — centered between corners, 30px gap each end */}
          <g fill="#7a5a22">
            <polygon points="14,44 21,51 14,58 7,51"/>
            <polygon points="14,68 21,75 14,82 7,75"/>
            <polygon points="14,92 21,99 14,106 7,99"/>
            <polygon points="14,116 21,123 14,130 7,123"/>
            <polygon points="14,140 21,147 14,154 7,147"/>
          ...
          <g fill="#3d2c10">
            ...
            <polygon points="14,132 17,135 14,138 11,135"/>
          ...
          <g fill="#7a5a22">
            ...
            <polygon points="506,116 513,123 506,130 499,123"/>
            <polygon points="506,140 513,147 506,154 499,147"/>
          ...
          <g fill="#3d2c10">
            ...
            <polygon points="506,132 509,135 506,138 503,135"/>
      ...
      {/* Wordmark overlaid as HTML — eliminates SVG font rendering artifacts */}
      <div style={{
        position: 'absolute',
        inset: 0,
        display: 'flex',
        ...
        <span style={{ color: '#6a4e20', fontSize: w * 0.038, lineHeight: 1 }}>✦</span>
        <span style={{
          fontFamily: "'Teko', sans-serif",
          fontSize: w * 0.295,
          fontWeight: 500,
